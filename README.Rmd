...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/scip)](https://CRAN.R-project.org/package=scip)
[![CRAN downloads](https://cranlogs.r-pkg.org/badges/scip)](https://CRAN.R-project.org/package=scip)
...
Suite](https://arxiv.org/abs/2511.18580).  [SCIP](https://www.scipopt.org/) is
...
vignette](https://bnaras.github.io/scip/articles/scip-examples.html)
for examples. One of the easiest ways to use SCIP (and many other
solvers) is via [`CVXR`](https://cvxr.rbind.io/) (version 1.8.2 and
higher).
