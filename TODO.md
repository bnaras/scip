...
Add runtime parameter discovery so users can explore SCIP's ~2,700 native
hierarchical parameters from within R:
...
The existing `scip_set_param()` already handles setting; these complete
the read side.
